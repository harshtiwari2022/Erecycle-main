            ...
            <div className="container mx-auto px-4">
                <div className="hero-content text-center">
                    ...
                    <h1 className="h1 hero-title text-center md:text-start font-bold mb-6">
                        Your technology partner for innovation and impact.
                        <br /> <motion.span
                    ...
                    <p className="text-gray-700 mb-8 text-center md:text-start">
                        Erecycle: Revolutionizing the Management of E-Waste. Easily locate E-waste facilities using our platform. Your secret to sustainable development and ethical recycling.
                    </p>
