                ...
                <div className="container">
                    <div className="footer-brand">
                        ...
                        <p className="footer-text">
                            Erecycle: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform.
                        </p>
                        <form onSubmit={SendMsg} className="newsletter-form mb-0 md:mb-4">
                            <input
                                ...
                                className="email-field outline-none"
                    ...
                    <ul className="footer-list">
                        ...
                        <li className="footer-item">
                            ...
                            <address className="contact-link address">
                                Ghaziabad<br />Uttar Pradesh, 201009
                            </address>
                        </li>
                        <li className="footer-item">
                        ...
                        <li className="footer-item">
                            ...
                            <Link
                                target="_blank"
                                rel="noopener noreferrer"
                                href="mailto:contact@Erecycle.com"
                                className="contact-link"
                            >
                                contact@Erecycle.com{" "}
                            </Link>
                        </li>
                        <li className="footer-item">
            ...
            <div className="footer-bottom">
                <div className="container">
                    <p className="copyright">
                        Copyright &copy; 2024 Erecycle | All Rights Reserved
                    </p>
