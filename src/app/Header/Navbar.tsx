    ...
    return (
        <header className={`header ${isHeaderActive ? "active" : ""}`} data-header>
            <div className="container shadow-md">
                <Link href="/" className="text-5xl py-10">
                    <Image
                        src={logo}
                        alt="Erecycle"
                        width={100}
                ...
                <h1 className='font-montserrat font-bold text-xl ml-12 md:ml-4 md:text-2xl text-blue-600 flex items-center gap-[1vh]'>
                ...
                {user ? (
                    <div className="relative">
                        ...
                        >
                            <div className="w-24 h-24 p-3 rounded-full">
                                <img src={`https://api.dicebear.com/8.x/initials/svg?seed=${user.username}`}
                                    alt=""
                        ...
                        {isDropdownOpen && (
                            <div className="absolute top-20 right-0 projects p-4  shadow-md divide-y rounded-lg w-52 mt-2">
