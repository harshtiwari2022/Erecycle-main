    ...
    return (
        <>
            <div className="my-3 text-center">
                <span className=" text-4xl font-bold">Welcome to Erecycle</span>
            ...
            <div className="mx-auto w-4/5 md:w-256 h-[90vh] md:h-[70vh]">
                <div className="relative flex flex-col md:flex-row p-6 bg-white shadow-2xl rounded-2xl">
                    ...
                    <div className="flex flex-col justify-center p-4 md:w-1/2">
                        <div className="py-4">
                            ...
                            <input
                                type="text"
                                className="w-full p-2 sign-field outline-none rounded-md placeholder:font-light placeholder:text-gray-500"
                                name="username"
                                id="username"
                        ...
                        <div className="py-4">
                            ...
                            <input
                                type="text"
                                className="w-full p-2 px-4 sign-field outline-none rounded-md placeholder:font-light placeholder:text-gray-500"
                                name="email"
                                id="email"
                                placeholder="Email"
                                onChange={handleInputChange}
                ...
                <button
                    className="w-full bg-black mt-4 text-white px-6 py-4 rounded-lg mb-6 hover:bg-blue-700 hover:border hover:border-gray-300"
                    onClick={register}
                >
                    Sign Up
                </button>
